...
<style scoped>
    ...
    .login_body .login_btn input{ width:100%; height:100%; background:#44BB5C; border-radius: 3px; border:none; display: block; color:white; font-size: 20px;}
    .login_body .login_link{ display: flex; justify-content:space-between; padding:0 20px}
    .login_body .login_link a{ text-decoration: none; margin:0 5px; font-size: 12px; color:#44BB5C;}
</style>
